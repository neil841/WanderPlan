 ...
 *
 * Multi-section form for creating new proposals
 */
        ...
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
          ...
          <div className="rounded-lg border p-6 space-y-4">
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                Enter the proposal title and client details
              </p>
            </div>
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <div className="flex justify-between">
                    <FormDescription>
                      A descriptive title for this proposal
                    </FormDescription>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormDescription>
                    Link this proposal to an existing trip
                  </FormDescription>
                  <FormMessage />
                </FormItem>
              )}
          ...
          <div className="rounded-lg border p-6 space-y-4">
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                Add services and products to include in this proposal
              </p>
            </div>
